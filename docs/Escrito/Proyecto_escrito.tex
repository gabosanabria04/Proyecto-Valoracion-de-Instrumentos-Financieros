...
\begin{itemize}
  ...
  \item Valor en Riesgo (VaR) para niveles de confianza del 95\% y 30\%, i.e. $F_X(\mathrm{VaR}_p) = \Pr\bigl[X \le \mathrm{VaR}_p\bigr] = p
$
  \item Valor en Riesgo Condicional (CVaR), definido como la esperanza condicional del valor del portafolio en las colas correspondientes de la distribución, i.e. $\mathrm{CVaR}_p(X) = \mathbb{E}\bigl[X \mid X \ge \mathrm{VaR}_p\bigr]
$
\end{itemize}
